            ...
            child: Column(
              ...
              children: [
                RichText(
                  text: TextSpan(
                    text: 'Core & Back\nfitness program',
                    style: TextStyle(fontSize: DynamicSize.Aaheight(24), color: Color(0xFF1F2F70), fontFamily: 'DMSans',
                        fontWeight: FontWeight.w500),
                  ),
                ),
                SizedBox(
                    height: DynamicSize.Aaheight(12)
                ),
                RichText(
                  text: TextSpan(
                ...
                SizedBox(
                    height: DynamicSize.Aaheight(38)
                ),
                Row(
                  ...
                  children: [
                    ...
                    RichText(
                      text: TextSpan(
                        ...
                        style: TextStyle(fontSize: DynamicSize.Aaheight(17), color: Colors.black, fontFamily: 'DMSans', fontWeight: FontWeight.w500),
                      ),
                    ),
                    IconButton(
                      onPressed: (){},
                ...
                Row(
                  ...
                  children: [
                    RichText(
                      text: TextSpan(
                        text: 'Day1',
                        style: TextStyle(fontSize:DynamicSize.Aaheight(17), color: Color(0xFF1F2F70), fontFamily: 'DMSans', fontWeight: FontWeight.w500),
                      ),
                    ),
                  ],
                ),
                SizedBox(
                    height: DynamicSize.Aaheight(24)
                ),
                RichText(
                  text: TextSpan(
                    text: 'Congratulations you have just taken the first step to back fitness and core strength you never knew you had! ',
