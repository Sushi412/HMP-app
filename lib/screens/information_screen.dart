...
import 'package:heath_matthews_physio/services/userData.dart';
...
class _informationScreenState extends State<informationScreen> {
  ...
  String? _ageValidator = null;

  @override
  Widget build(BuildContext context) {
    final routeData =
        ModalRoute.of(context)!.settings.arguments as Map<String, dynamic>;
    final firstName = routeData['firstName'];
    final lastName = routeData['lastName'];
    final phoneNo = routeData['phoneNo'];
    final image = routeData['profile'];
                      ...
                      children: [
                        OutlinedButton(
                          ...
                          onPressed: () {
                            ...
                            if (_ageContoller.text.trim().length == 0) {
                              setState(() {
                                _ageValidator = 'Enter the Age';
                              });
                              flag = false;
                            }
                            if (flag) {
                              ...
                              userData(uid: firebaseUser!.uid.toString())
                                  .uploadUserData(
                                      ...
                                      gender: genderData!,
                                      height: int.parse(_hstatus),
                                      weight: int.parse(_wstatus),
                                      age: int.parse(_ageContoller.text.trim()),
                                      image: image)
