...
height: DynamicSize.Aaheight(184),
                    ...
                    child: Row(
                      ...
                      children: [
                        Image.asset("images/foam_rolling.png")
                      ],
                    ),
                  ),
                ],
          ...
          Column(
            children: [
              Container(
                ...
                child: Padding(
                  padding: EdgeInsets.only(top:DynamicSize.Aaheight(42),left: DynamicSize.Aaheight(42),right: DynamicSize.Aaheight(42)),
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('Add Note to Exercise (Optional)',
